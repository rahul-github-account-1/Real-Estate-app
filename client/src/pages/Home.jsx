...
export default function Home() {
  ...
  return (
    <main className='bg-gray-800 h-vh'>
      {/* top */}
      <div className='flex flex-col gap-6 p-28 px-3 w-8/12 mx-auto'>
        <h1 className='text-neutral-200 font-bold text-3xl lg:text-6xl'>
        ...
        <div className='w-8/12'>
          <Swiper navigation>
            {imageUrls && imageUrls.map((url) => (
              <SwiperSlide key={url}>
                <div
                  className='h-[550px]   transition-all duration-300 hover:scale-100'
                  style={{
